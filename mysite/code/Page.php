...
class Page_Controller extends ContentController {
	...
	public function init() {
		...
		// See: http://doc.silverstripe.org/framework/en/reference/requirements
  		...
  		Requirements::css($this->ThemeDir()."/css/landing-page.css");
  		Requirements::css($this->ThemeDir()."/css/font-awesome.min.css");
  		Requirements::css("http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic");
